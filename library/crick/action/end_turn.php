...
class End_Turn extends \Library\Template\Game\Action { // This object is never saved to the database
		
	public function preform(\Library\Template\I_Game $game, \Library\Template\Game\I_Player $player)
	{
		$game->trigger_event('beforeEnd_Turn', $player, $this);
		// DO SOME STUFF HERE
		$game->trigger_event('afterEnd_Turn', $player, $this);
	}
